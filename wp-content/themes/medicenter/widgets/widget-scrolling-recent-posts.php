<?php
class mc_scrolling_recent_posts_widget extends WP_Widget 
{
	/** constructor */
    function __construct()
	{
		$widget_options = array(
			'classname' => 'mc-scrolling-recent-posts-widget',
...
//register widget
function mc_scrolling_recent_posts_widget_init()
{
	return register_widget("mc_scrolling_recent_posts_widget");
}
add_action('widgets_init', 'mc_scrolling_recent_posts_widget_init');
?>