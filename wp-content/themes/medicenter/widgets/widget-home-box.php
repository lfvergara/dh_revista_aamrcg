...
class mc_home_box_widget extends WP_Widget 
{
	...
	function form($instance) 
	{
		...
		jQuery(document).ajaxStop(function(){
			...
			if(jQuery(".widgets-holder-wrap #widget-home-box-button_style_id").length)
			{
				selector = "#" + jQuery(jQuery(".widgets-holder-wrap #widget-home-box-button_style_id")[1]).val();
				jQuery(".widgets-holder-wrap #widget-home-box-button_style_id").remove();
			}
		...
		jQuery(document).ready(function($){
			...
			$("#<?php echo esc_attr($this->get_field_id('color')); ?>").change(function(){
